...
function advanceHiit(){
  ...
  function getExercises(cats,count){
   ...
   const shadowExs=getExercises(["Shadow Boxing","defensive footwork"],6);
    ...
    const bagExs1=hiitType==="kickboxing"?getExercises(["kickboxing combo"],4):hiitType==="mixed"?getExercises(["kickboxing combo","boxing only"],4):getExercises("Heavy Bag"[],4);
    ...
    const bagExs2=hiitType==="kickboxing"?getExercises(["Heavy Bag"],8).slice(2,6):hiitType==="mixed"?getExercises(["heavy bag combo","kickboxing combo"],8).slice(2,6):getExercises(["Heavy Bag"],8).slice(2,6);
    ...
    const bagExs3=hiitType==="kickboxing"?getExercises(["kickboxing combo"],12).slice(4,8):hiitType==="mixed"?getExercises(["kickboxing combo","power punching"],12).slice(4,8):getExercises(["Heavy Bag"],12).slice(4,8);
